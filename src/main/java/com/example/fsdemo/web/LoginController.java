...
public class LoginController {
    ...
    public ResponseEntity<?> login(@RequestBody AccountCredentials creds) {
        ...
        // Max-Age should be less than or equal to JWT expiration.
        // Set it to JWT expiration for simplicity, or slightly less.
        // Use Duration.ofMillis for accuracy.
        long maxAgeSeconds = jwtService.getExpirationTime() / 1000;
        ...
        return ResponseEntity.ok()
                ...
                // Expose Authorization header to frontend JavaScript if needed
